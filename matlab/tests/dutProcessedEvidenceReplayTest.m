classdef dutProcessedEvidenceReplayTest < matlab.unittest.TestCase
    ...
    methods (Test)
        function testSupplyComparisonReportsConfoundedHardwareStates(testCase)
            ...
            conditionLabels = [ ...
                "+/-3 V (50 Ohm connected)"; ...
                "+/-6 V (50 Ohm disconnected)"];
            referenceNvRtHz = 5.2;
            evidenceMetadata = struct( ...
                comparisonStatus="confounded-two-factor", ...
                supplyEffectIsolated=false, ...
                auxiliary50OhmStatus=["connected"; "disconnected"]);
            ...
            testCase.verifyEqual( ...
                paths.comparisonStatus, "confounded-two-factor");
            testCase.verifyFalse(paths.supplyEffectIsolated);
            testCase.verifyTrue(contains( ...
                paths.interpretation, "not supply-isolated"));
        end
