...
set_location_assignment PIN_AB28 -to sw_clk_div
set_location_assignment PIN_AC28 -to sw_por
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to sw_clk_div
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to sw_por
...
set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"      -to sw_clk_div
set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"      -to sw_por
